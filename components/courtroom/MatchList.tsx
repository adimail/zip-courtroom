...
export function MatchList({ matches, selectedMatchId, onSelectMatch }: MatchListProps) {
  ...
  return (
    <div className="bg-slate-50 border border-slate-200 rounded-lg overflow-hidden flex flex-col h-[400px] lg:h-[600px] shadow-sm">
      <div className="p-3 md:p-4 bg-slate-100 border-b border-slate-200 shrink-0">
        ...
        <div className="divide-y divide-slate-200">
          {reversedMatches.map((match) => (
            <button
              ...
              className={cn(
                "w-full text-left p-3 md:p-4 hover:bg-slate-100 transition-colors flex flex-col gap-1.5 md:gap-2 group",
